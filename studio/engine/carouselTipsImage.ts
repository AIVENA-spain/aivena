...
export async function renderTipsImageStyled(
  ...
  specs.push(DesignSpec.parse({
    ...
    elements: [
      ...
      ...(plan.agency_line ? [{ type: "text", bbox: [160, 630, 920, 730], content: wrap(plan.agency_line, FR, 34, 740), font: FR, size: 34, colour: NAVY, align: "center", line_height: 46 }] : []),
      { type: "text", bbox: [180, plan.agency_line ? 755 : 660, 900, plan.agency_line ? 820 : 790], content: wrap(plan.cta_action, "Jost", 27, 700), font: "Jost", size: 27, colour: mix(NAVY, CREAM, 0.8), align: "center", line_height: 40 },
      { type: "text", bbox: [180, 840, 900, 940], content: wrap(plan.cta_keyword, FR, 32, 700), font: FR, size: 32, colour: NAVY, align: "center", italic: true, line_height: 44 },
