...
- budget: the lead's OWN search budget. NOT a price they offer on a specific listing (that is decision "offer_or_negotiation"), NOT a listing's asking price (that is specific_property), and NOT a mortgage, loan or financing amount (that is financing_ready). "clear" = an amount or range, including approximate ("around €265,000", "under 180k", "max 312.500"); "vague" = a level with no amount ("nothing too expensive", "a modest place"); "none" = no budget, INCLUDING when they say they do not know yet, or that it depends on what is available. Not knowing is not a vague budget.
...
- financing_ready: cash buyer, mortgage approved, or funds ready. A mortgage or loan amount belongs here, never in budget.
- decision, the strongest that applies: "asks_how_to_proceed" (how to offer, reserve, proceed or send documents), "offer_or_negotiation" (they name a price they would pay for a specific listing, or haggle — stronger than asking how to proceed; that price is never their budget), "agrees_to_reserve_pay_or_documents", "ready_to_close_now", "already_committed" (already reserved, paid a deposit or signed), or "none".
