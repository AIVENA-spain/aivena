...
export function buildPalette(input: PaletteInput): string {
  ...
  parts.push('',
    ...
    '· ORDINARY SELLING REASONING DOES NOT COME OFF THIS LIST. How selling generally works —',
    '  "launching too high can make buyers hesitate", "a listing that sits starts to look like a',
    '  problem", "five versions of one home send five different messages" — is a tendency you may',
    '  write from judgement and experience, in that register: it can happen, it often does, not it',
    '  always will. What DOES have to come off this list, every time: law, tax, a deadline, a',
    '  statistic, a ranking, a specific measurable outcome, anything with a number in it, anything',
    '  about a named place, a current market or a particular platform, and anything about this',
    '  agency\'s own record or services. Those follow the evidence rules whatever register they are',
    '  written in.',
