...
export function cardRules(card: BankCard): string {
  ...
  return [
    ...
    '',
    'IF THE POST ARGUES ANY OF THESE, IT MUST ESTABLISH THEM FIRST.',
    'They are the checks this subject needs — NOT an agenda for the post. The agent asked their own',
    'question; if it does not turn on one of these, leave it alone and answer what was asked:',
    list(card.must),
    '',
