// CAPTURE (version control) of the deploy-only Edge Function `generate-lead-embedding`.
// Slug: generate-lead-embedding · id b1ea8ff1-1949-4b74-a393-7eea92e06367 · version 17 · ACTIVE
// verify_jwt=TRUE — platform-level auth; keep it true on any redeploy.
// ezbr_sha256: 28e8edb77e3142df9ebbf4779f9e4725d0ed8604c1ac9e690ec0aff1bf66ab6d
// Captured 2026-09-01 from the DEPLOYED source, byte-for-byte (no secrets — OpenAI key from env).
