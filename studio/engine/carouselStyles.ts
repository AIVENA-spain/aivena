...
function cartelPlanned(plan: CarouselPlan, agency: string, contact: string, brand: CarouselBrand, lang = "es",
  ...
  specs.push(DesignSpec.parse({
    ...
    elements: [
      ...
      ...(plan.agency_line ? [{ type: "text", bbox: [120, 600, 960, 700], content: wrap(plan.agency_line, "Archivo", 30, 820), font: "Archivo", size: 30, colour: NAVY, align: "center", line_height: 42 }] : []),
      { type: "text", bbox: [140, plan.agency_line ? 730 : 620, 940, plan.agency_line ? 800 : 760], content: wrap(plan.cta_action, "Archivo", 28, 780), font: "Archivo", size: 28, colour: mix(NAVY, brand.gold, 0.75), align: "center", line_height: 40 },
...
function serenoPlanned(plan: CarouselPlan, agency: string, contact: string, brand: CarouselBrand,
  ...
  specs.push(DesignSpec.parse({
    ...
    elements: [
      ...
      ...(plan.agency_line ? [{ type: "text", bbox: [160, 820, 920, 900], content: wrap(plan.agency_line, FR, 34, 740), font: FR, size: 34, colour: NAVY, align: "center", line_height: 46 }] : []),
