...
const NEW = ["5", "14", "3", "6"];
const NAME: Record<string, string> = { "5": "#5 Listing", "14": "#14 Just Sold", "3": "#3 Luxury (Canva p3, strip-plate v2)", "6": "#6 Villa (Canva p6 via 6b, strip-plate + Belgan Aesthetic)" };
...
async function main() {
  ...
  const comps: any[] = [{ input: bar(W, "STUDIO BATCH 2 (replicated to Canva) — #5 Listing · #14 Just Sold · #3 Luxury (Canva p3) · #6 Villa (Canva p6) — across property types", 46, 14), left: 0, top: 0 }];
